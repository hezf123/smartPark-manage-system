...
export default function Dashboard() {
    ...
    return <div className='dashboard'>
        ...
        <Row gutter={16} className='mt'>
            ...
            <Col span={6}>
                <Card title="充电桩空闲统计" style={{ height: "100%" }}>
                    <div className='wrap'>
                        <Progress type='circle' percent={75} className='mt'></Progress>
                        <Statistic title="总充电桩数" value={75} suffix=' /100' className='mt' />
                    </div>
                </Card>
            </Col>
            <Col span={6}>
                <Card title="实时车辆信息" style={{ height: "100%" }}>
                    <Timeline items={[
                        {
                            content: <><Tag color="green">进场</Tag>08:24车辆 京A66666</>
                        },
                        {
                            content: <><Tag color="red">出场</Tag>09:15 车辆 京A66666  </>,
                            color: 'red',
                        },
                        {
                            content: <><Tag color="green">进场</Tag>09:22 车辆 京A23456  </>,
                        },
                        {
                            content: <><Tag color="red">出场</Tag>10:43 车辆 京A18763  </>,
                            color: 'red',
                        },
                        {
                            content: <><Tag color="green">进场</Tag>13:38 车辆 京A88888  </>,
                        },
                        {
                            content: <><Tag color="green">进场</Tag>14:46 车辆 京A23456  </>,
